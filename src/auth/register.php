        ...
        <div class="py-8 px-10">
            ...
            <form id="loginForm" class="space-y-6">
                <div class="relative">
                    <input 
                        ...
                        required
                    >
                    <label for="name" class="absolute left-4 top-3 text-gray-500 pointer-events-none transition-all duration-200 peer-focus:text-purple-600">Full Name</label>
                ...
                <div class="relative">
                    <input 
                        ...
                        required
                    >
                    <label for="confirmPassword" class="absolute left-4 top-3 text-gray-500 pointer-events-none transition-all duration-200 peer-focus:text-purple-600">Confirm Password</label>
                    <div class="absolute right-3 top-3 text-gray-400">
                ...
                <div class="text-center">
                    <p class="text-gray-500 text-sm">Already have an account? 
                        <a href="#" class="text-purple-600 hover:text-purple-800 font-medium">Sign in</a>
                    </p>
                </div>
            </form>
            ...
            <div class="mt-8">
                ...
                <div class="mt-6 grid grid-cols-3 gap-3">
                    <button type="button" class="flex items-center justify-center py-2 px-4 border border-gray-300 rounded-lg bg-white hover:bg-gray-50 transition">
